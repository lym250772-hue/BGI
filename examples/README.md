...
| `zhihu_sample.json` | 知乎 | 内容 | 1,607 | 10,326 | 浏览器内fetch API ~3-5/s |
| `xiaohongshu_sample.json` | 小红书 | 内容 | 2,556 | 2,986 | API拦截 + v3持久化浏览器 |
| `douyin_sample.json` | 抖音 | 内容 | 1,167 | 1,267 | X-Bogus + 纯HTTP API |
| `tieba_sample.json` | 贴吧 | 内容 | 1,141 | 876 | 浏览器+DOM ~10/s |
...
> **清洗层**: 6步管道,作者感知去重(同作者+相似=丢弃,不同作者+相似=情报保留),内容角色五分类
